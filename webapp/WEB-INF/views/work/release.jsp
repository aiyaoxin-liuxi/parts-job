...
<title></title>
	...
	<script type="text/javascript" src="${basePath}/js/work/release.js"></script>
</head>
<body>
<jsp:include page="/common/header.jsp" />
	<form id="inputSub" action="" method="POST">
					...
					<ul class="jz-left">
						<li class="one">
							<p onclick="window.location.href='toReleaseJobInfo'">
								<img src="${basePath}/image/fabu2.png" alt="" /> 发布兼职 
							</p>
						</li>
						<li class="two">
							<p onclick="window.location.href='parttimeMannage'">
								<img src="${basePath}/image/guanli.png" alt=""/> 兼职管理 
							</p>
						</li>
						<li class="three">
							<p>
								<img src="${basePath}/image/newsqiye1.png" alt="" /> <a href="">企业信息</a>
							</p>
						</li>
						<li class="three">
							<p>
								<img src="${basePath}/image/zhanghu.png" alt="" /> <a href="">账户信息</a>
							</p>
						</li>
						<li class="three">
							<p>
								<img src="${basePath}/image/bangding1.png" alt="" /> <a href="">账号绑定</a>
							</p>
						</li>
						<li class="three">
							<p>
								<img src="${basePath}/image/anquan.png" alt="" /> <a href="">安全中心</a>
							</p>
						</li>
					</ul>
					<ul class="jz-center">
						...
						<li class="jz-title">
							<p class="fabu ">
								<span style="margin-right: 50px;" class="fabu_checked dian1 fabu_jz">发布</span>
		...
		<div class="hide1 jz-tanchu">
			<ul>
				<li class="one"><img src="${basePath}/image/logo11.jpg" alt="" class="logo" />
				...
				<li class="four"><span class="che dianji">关闭</span> 
				<span id="subForm"  class="ched dianji">确定</span>
				</li>
			</ul>
		</div>
	</form>
